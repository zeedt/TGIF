...
public class ChatHeadService2 extends Service {			
				...
				switch (event.getAction()) {
					...
					case MotionEvent.ACTION_UP:
						...
						if(inBounded){
							...
							stopService(new Intent(ChatHeadService2.this, ChatHeadService2.class));
							inBounded = false;
							break;
						}
	...
	public void onConfigurationChanged(Configuration newConfig) {
	    ...
	    if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
	    	Log.d(Utils.LogTag, "ChatHeadService2.onConfigurationChanged -> landscap");
	    	...
	    	Log.d(Utils.LogTag, "ChatHeadService2.onConfigurationChanged -> portrait");
